...
Same attack as previous question would still work. The XOR of the hidden key does not matter

Here's a construction of a forgery:
...
This gives you Enc(B_1), Enc(B_2), Enc(("A" * 15 + "0x01") Xor Enc(B_1) XOR key_last), Enc(("A" * 15 + "0x01") Xor Enc(B_2) XOR key_last)
...
Tag = Enc(B_1) || Enc(("A" * 15 + "0x01") Xor Enc(B_2) XOR key_last)
